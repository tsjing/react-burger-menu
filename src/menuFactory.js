...
export default (styles) => {
  ...
  return Radium(React.createClass({
    ...
    render() {
      return (
        <div>
          {!this.props.noOverlay ? <div className="bm-overlay" onTouchTap={ this.toggleMenu } style={this.getStyles('overlay')}></div> : null}
          <div id={this.props.id} className={"bm-menu-wrap"} style={this.getStyles('menuWrap')}>
            ...
            <div style={this.getStyles('closeButton')}>
              <CrossIcon onTouchTap={this.toggleMenu} styles={this.props.styles} customIcon={this.props.customCrossIcon ? this.props.customCrossIcon : null} />
            </div>
          </div>
          <BurgerIcon  onTouchTap={this.toggleMenu} styles={this.props.styles} customIcon={this.props.customBurgerIcon ? this.props.customBurgerIcon : null} />
        </div>
      );
    }
  }));
