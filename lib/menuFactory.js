  ...
  return (0, _radium2['default'])(_react2['default'].createClass({
    ...
    render: function render() {
      ...
      return _react2['default'].createElement(
        'div',
        null,
        !this.props.noOverlay ? _react2['default'].createElement('div', { className: 'bm-overlay', onTouchTap: this.toggleMenu, style: this.getStyles('overlay') }) : null,
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(_CrossIcon2['default'], { onTouchTap: this.toggleMenu, styles: this.props.styles, customIcon: this.props.customCrossIcon ? this.props.customCrossIcon : null })
          )
        ),
        _react2['default'].createElement(_BurgerIcon2['default'], { onTouchTap: this.toggleMenu, styles: this.props.styles, customIcon: this.props.customBurgerIcon ? this.props.customBurgerIcon : null })
      );
    }
  }));
};
